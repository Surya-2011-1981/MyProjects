...
create_password_Visiblity.onclick = (e) => {
  ...
  if (create_Password.type === "password") {
    ...
    create_password_Visiblity.src = "/assets/hidepassword.svg";
    create_password_Visiblity.title = "Hide Password";
  } else {
    console.log("text");
    create_Password.type = "password";
    // confirm_Password.type = "password";
    create_password_Visiblity.src = "/assets/showpassword.svg";
...
confirm_password_Visiblity.onclick = (e) => {
  ...
  if (confirm_Password.type === "password") {
    ...
    // create_Password.type = "text";
    confirm_Password.type = "text";
    confirm_password_Visiblity.src = "/assets/hidepassword.svg";
    confirm_password_Visiblity.title = "Hide Password";
  } else {
    console.log("text");
    // create_Password.type = "password";
    confirm_Password.type = "password";
    confirm_password_Visiblity.src = "/assets/showpassword.svg";
